...
public class GeradorZumbis : MonoBehaviour {
	...
	void Update () {
		...
		// this a way to record time using what unity offers
	...
	IEnumerator GerarNovoZumbi()
	{
		...
		Controla_Inimigo zumbi = Instantiate (Zumbi, posicaoDeCriacao, transform.rotation)
			.GetComponent<Controla_Inimigo>();
